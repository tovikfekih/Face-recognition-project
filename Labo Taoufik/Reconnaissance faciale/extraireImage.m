...
% Cette fonction consiste a extraire une colonne a partir d'une matrice X
% de taille n (images) et m (pixels). Aprés avoir extrait la colonne on
% doit la supprimer de la matrice X. 

% Les données d'entrée sont :
%   matrice - La matrice X initiale (complete)
%   index - L'index de l'image qu'ont veut extraire
